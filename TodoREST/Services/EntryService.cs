...
namespace GeoTagger.Services
{
    public class EntryService
    {
        ...
        string AzureConnectionString = "DefaultEndpointsProtocol=https;AccountName=mug2018xamarin;AccountKey=CHAR2bKmTymbHCZyue+e8sU6yHOw9i53+kvB4a/8v0ABzs2GrKG5fG2jMmnDZSQgfCSv4A1U3aEMaI/JyrW4WQ==;EndpointSuffix=core.windows.net";
